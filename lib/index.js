...
function AddToCalendar(WrappedButton, WrappedDropdown) {
  ...
  var shareSites = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _enums.SHARE_SITES;
  ...
  function (_Component) {
      ...
      value: function render() {
        ...
        return _react.default.createElement("div", {
          ...
          return _react.default.createElement("a", _extends({}, linkProps, {
            ...
            href: (0, _utils.buildShareUrl)(event, item, shareSites)
          }), item);
        })));
      }
    }]);
    ...
    items: _propTypes.default.arrayOf(_propTypes.default.oneOf(Object.keys(shareSites).map(function (itm) {
      return shareSites[itm];
    }))),
    ...
    dropdownProps: {},
    filename: 'download',
    items: Object.keys(shareSites).map(function (itm) {
      return shareSites[itm];
    }),
    linkProps: {}
  }), _temp2;
