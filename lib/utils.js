...
var getVtimezoneFromMomentZone = function getVtimezoneFromMomentZone(_ref4) {
  ...
  var nextDSTSwitch = zone.untils.findIndex(function (u) {
  ...
  var DSTSwitches = zone.untils.slice(nextDSTSwitch - 1, lastDSTSwitch + 1);
  var zTZitems = DSTSwitches.map(function (until, i) {
    var type = i % 2 === 0 ? "STANDARD" : "DAYLIGHT";

    var momDtStart = _momentTimezone.default.tz(until, timezone);

    var momNext = _momentTimezone.default.tz(zone.untils[i + 1], timezone);
