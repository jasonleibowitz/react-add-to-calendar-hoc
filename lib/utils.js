...
var googleShareUrl = function googleShareUrl(_ref) {
  ...
  return "https://calendar.google.com/calendar/render?action=TEMPLATE&dates=".concat(startDatetime, "/").concat(endDatetime).concat(timezone && "&ctz=".concat(timezone), "&location=").concat(location, "&text=").concat(title, "&details=").concat(description, "&recur=RRULE:").concat(recurring);
};
/**
...
var yahooShareUrl = function yahooShareUrl(_ref2) {
  ...
  return "https://calendar.yahoo.com/?v=60&view=d&type=20&title=".concat(title, "&st=").concat(startDatetime, "&dur=").concat(duration, "&desc=").concat(description, "&in_loc=").concat(location, "&recur=RRULE:").concat(recurring);
};
/**
...
var buildShareUrl = function buildShareUrl(_ref4, type) {
  var _ref4$description = _ref4.description,
      ...
      _ref4$recurring = _ref4.recurring,
      recurring = _ref4$recurring === void 0 ? '' : _ref4$recurring;
