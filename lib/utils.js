...
var googleShareUrl = function googleShareUrl(_ref) {
  ...
  return "https://calendar.google.com/calendar/render?action=TEMPLATE&dates=".concat(startDatetime, "/").concat(endDatetime).concat(timezone && "&ctz=".concat(timezone), "&location=").concat(location, "&text=").concat(title, "&details=").concat(description, "&recur=").concat(recurring);
};
/**
...
var yahooShareUrl = function yahooShareUrl(_ref2) {
  ...
  return "https://calendar.yahoo.com/?v=60&view=d&type=20&title=".concat(title, "&st=").concat(startDatetime, "&dur=").concat(duration, "&desc=").concat(description, "&in_loc=").concat(location, "&recur=").concat(recurring);
};
/**
